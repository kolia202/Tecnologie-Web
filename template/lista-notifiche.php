...
<p class="notifiche-p">Tieni d'occhio questa pagina per rimanere aggiornato su tutte le novità!</p>
<?php if(count($templateParams["notifiche"]) == 0): ?>
    <div class="card ms-3 me-3">
        <div class="card-body text-center">
            <p class="notifiche-p">Nessuna nuova notifica!</p>
        </div>
    </div>
<?php else: ?>
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <form action="notifiche.php" method="POST">
                        <button type="submit" class="btn btn-primary elimina-notifica" name="eliminanotifica" value="<?php echo $notifica["Id_notifica"] ?>">Elimina</button>
                    </form>
                </div>
            </div>
        </div>        
