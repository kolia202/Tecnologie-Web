<div class="container mt-4 ps-4 pe-4 cont-shipping">
                ...
                <div class="card shadow card-border ps-3 pe-3 pt-2 pb-2 mt-4">
                    <div class="d-flex justify-content-center align-items-center">
                        <div class="form-check d-flex align-items-center ms-2 mb-0">
                            <input class="form-check-input shipping-radio radio-input mb-1 me-1" type="radio" name="shipping" id="<?php echo $spedizione["Id_spedizione"] ?>" value="<?php echo $spedizioneGratuita ? 3 : $spedizione["Id_spedizione"] ?>" required />
                            <label class="text fw-bold" for="<?php echo $spedizione["Id_spedizione"] ?>">
                                <?php echo $spedizione["Nome"]; ?>
                            </label>
                        </div>
                        <p class="shipping-price<?php echo $spedizione["Id_spedizione"]; ?> mb-0 ms-auto text-italic me-2"><strong>Prezzo:</strong> <?php echo getFormattedPrice($spedizione["Costo"]) ?></p>
                    </div>
    ...
    <div class="text-center mt-4">
        <a href="../php/carrello.php" type="button" class="text back">Indietro</a>
    </div>
</div>
