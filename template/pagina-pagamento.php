...
<form method="POST" action="pagamento.php">
    <?php if (isset($_SESSION["paymenterror"])): ?>
        <p class="error text-center"><?php echo $_SESSION["paymenterror"]; ?></p>
    <?php endif; ?>
    ...
    <button type="button" class="btn btn-outline paga-punti mb-3">Paga con i punti</button>
    <input type="hidden" name="usapunti" class="usa-punti" value="0">
    <p class="errore-punti text-center"></p>
    <section>
    ...
    <div class="text-center">
        <button type="submit" name="invia" class="btn btn-sm fw-bold button-invia mt-4 mb-4">Riepilogo Ordine</button>
    </div>
</form>