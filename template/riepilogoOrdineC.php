<div class="container mt-4 ps-4 pe-4 cont-order">
    ...
    <h2 class="text mt-3"><strong>Punti usati: </strong><?php echo $_SESSION["puntiusati"]; ?></h2>
    <h2 class="text"><strong>Totale: </strong><?php echo getFormattedPrice($_SESSION["totalecarrello"] + $costospedizione); ?></h2>
