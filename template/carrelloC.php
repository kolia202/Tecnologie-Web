                ...
                <div class="col-12 col-md-4 mb-4 mt-1">
                    <section class="text-center">
                        <a class="text-decoration-none" href="../php/dettaglioProdotto.php?id=<?php echo $prodotto["Id_prodotto"]; ?>">
                            <img class="shadow img-carrello img-fluid" src="<?php echo IMG_DIR.$prodotto["Immagine"]; ?>" alt=""/>
                        ...
                        <?php else: ?>
                            <div class="d-flex align-items-center justify-content-center gap-1">
                                ...
                                <button type="button" class="btn ps-2 pe-2 pt-0 pb-0 button-empty decrease" id="<?php echo $prodotto["Id_prodotto"]; ?>">
                                    <i class="bi bi-dash-circle"></i>
                                </button>
                                <p class="m-0 text quantity"><?php echo $prodotto["Quantita"]; ?></p>
                                <button type="button" class="btn ps-2 pe-2 pt-0 pb-0 button-empty increase" id="<?php echo $prodotto["Id_prodotto"]; ?>">
