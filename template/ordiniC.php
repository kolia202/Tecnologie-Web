                            ...
                            <div class="card-body">
                                ...
                                <?php if (isAdminLoggedIn()): ?>
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn button-small fw-bold pt-0 pb-0 mb-2" data-bs-toggle="modal" data-bs-target="#order" <?php echo $ordine['Stato'] == 'Consegnato' ? 'disabled' : '' ?>>Aggiorna</button>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header pb-2">
                                                        <h1 class="title" id="staticBackdropLabel">Aggiorna Stato</h1>
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="ordini.php">
                                                            ...
                                                            <label for="stato" class="ps-1 d-block text-start text-italic">Stato</label>
                                                            <select class="form-select text text-input" name="stato" id="stato">
                                    ...
                                    <div class="text-center mt-3 mb-1">
                                        <a href="../php/singolo-ordine.php?id=<?php echo $ordine["Id_ordine"] ?>" type="button" class="btn button w-75">Riepilogo Ordine</a>
                                    </div>
                                <?php else: ?>
                                    <p class="text mb-2"><strong>Data: </strong><?php echo getFormattedDate($ordine["Data_effettuazione"]) ?></p>
                                    <p class="text mb-0"><strong>Stato: </strong><?php echo $ordine["Stato"]; ?></p>
                                    <div class="text-center mt-3">
                                        <a href="../php/tracciamento.php?id=<?php echo $ordine["Id_ordine"] ?>" type="button" class="btn button-outline w-75 mb-2">Traccia Ordine</a><br>
                                        <a href="../php/singolo-ordine.php?id=<?php echo $ordine["Id_ordine"] ?>" type="button" class="btn button w-75">Riepilogo Ordine</a>
                                    </div>
                                <?php endif; ?>
                            </div>
