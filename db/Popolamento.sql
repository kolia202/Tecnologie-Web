...
('Topolino Theo', "Theo è un topolino piccolo e vivace, con un morbido pelo grigio chiaro e occhietti brillanti pieni di curiosità. Agile e intelligente, ama esplorare ogni angolo e trovare nuovi nascondigli. Con il suo musetto adorabile e il suo spirito giocoso, Theo è il compagno perfetto per avventure minuscole ma piene di dolcezza.", 'TopolinoTheo.png', 'S', 6, 9.99, 100, 'Fattoria'),
('Mucca Dotty', "Dotty è una dolce e simpatica mucca dal manto bianco a macchie nere, sempre curiosa e affettuosa. Ama pascolare tranquilla nei prati e godersi il sole, ma non dice mai di no a qualche coccola. Con il suo musetto tenero e il suo carattere gioioso, Dotty porta allegria ovunque vada!", 'MuccaDotty.png', 'S', 30, 19.99, 200, 'Fattoria'),
('Procione Ringo', "Ringo è un procione furbo e vivace, con il suo soffice pelo grigio e la caratteristica mascherina nera sugli occhi. Sempre alla ricerca di nuove avventure, ama esplorare e scoprire tesori nascosti. Con il suo musetto simpatico e il suo spirito giocoso, Ringo è il perfetto compagno per chi cerca un amico pieno di energia e curiosità.", 'ProcioneRingo.png', 'S', 2, 34.99, 350, 'Fattoria'),
('Gallina Daisy', "Daisy è una gallina vivace e affettuosa, con un soffice piumaggio bianco. Sempre attenta e curiosa, ama esplorare il cortile e fare amicizia. Con il suo carattere dolce e il suo spirito gioioso, Daisy porta allegria ovunque vada!", 'GallinaDaisy.png', 'S', 7, 34.99, 350, 'Fattoria'),
('Topolino Martin', "Martin è un topolino curioso e energico, con un morbido pelo grigio e occhietti azzurri brillanti e pieni di vivacità. Sempre in movimento, ama esplorare ogni angolo e trovare piccoli tesori. Con il suo musetto dolce e il suo spirito giocoso, Martin è il perfetto compagno per chi ama l'avventura!", 'TopolinoMartin.png', 'S', 8, 34.99, 350, 'Fattoria'),
('Coccinella Scarlet', "Scarlet è una coccinella vivace e brillante, con il suo splendido guscio rosso punteggiato di cuoricini neri. Simbolo di fortuna e felicità, ama svolazzare tra i fiori e godersi il sole. Con il suo spirito allegro e il suo aspetto incantevole, Scarlet porta un tocco di magia ovunque vada!", 'CoccinellaScarlet.png', 'S', 18, 15.99, 160, 'Fattoria'),
('Coniglietto Spring', "Spring è un dolce coniglietto dal morbido pelo giallo, soffice come una nuvola primaverile. Sempre allegro e vivace, ama saltellare tra i prati e curiosare tra i fiori. Con il suo musetto tenero e gli occhietti brillanti, Spring porta gioia e dolcezza ovunque vada!", 'ConigliettoSpring.png', 'S', 4, 12.99, 130, 'Fattoria'),
('Pulcino Sunny', "Sunny è un pulcino dolcissimo, con piume gialle come il sole. Sempre allegro e vivace, ama saltellare tra i fiori e fare piccoli cinguettii felici. Con il suo spirito spensierato e il musetto tenero, Sunny ama far sorridere chiunque incontri!", 'PulcinoSunny.png', 'S', 16, 17.99, 180, 'Fattoria'),
('Coniglietto Jeremy', "Jeremy è un coniglietto dolce e timido, con un morbido pelo nocciola e orecchie lunghe che gli danno un aspetto tenero e curioso. Ama saltellare nel prato e esplorare il suo piccolo mondo, ma è anche un grande amante delle coccole. Con il suo carattere gentile e il musetto adorabile, Jeremy è il compagno perfetto per momenti di tranquillità e affetto.", 'ConigliettoJeremy.png', 'M', 8, 59.99, 600, 'Fattoria'),
('Rana River', "River è una rana vivace di un bel colore verde acceso. Ama passare il suo tempo tra i laghetti e le rive, saltellando da una foglia all'altra. Con il suo spirito giocoso e il suo carattere curioso, River porta un tocco di freschezza e allegria ovunque vada!", 'RanaRiver.png', 'S', 5, 29.99, 300, 'Fattoria'),
('Criceto Sparky', "Sparky è un criceto vivace e pieno di energia, con un morbido pelo dorato e un musetto sorridente e curioso. Sempre in movimento, ama correre sulla sua ruota e esplorare ogni angolo del suo piccolo mondo. Con il suo spirito allegro e il suo carattere giocoso, Sparky è il compagno perfetto per chi cerca un amico adorabile!", 'CricetoSparky.png', 'S', 15, 9.99, 100, 'Fattoria'),
...
('Coniglietto Ciro', "Ciro è un coniglietto dolce e curioso, con un morbido pelo beige. Ama saltellare nei prati e esplorare con un entusiasmo contagioso. Con il suo carattere vivace e affettuoso, Ciro è il compagno perfetto per chi cerca un amico gioioso e sempre pronto a far sorridere!", 'ConigliettoCiro.png', 'S', 26, 34.99, 350, 'Fattoria'),
('Castoro Giuseppe', "Giuseppe è un castoro vivace e laborioso, con un folto pelo marrone e una coda larga e piatta. Sempre occupato a costruire dighe e a raccogliere rami, è molto orgoglioso del suo lavoro. Con il suo carattere intraprendente, Giuseppe è il compagno perfetto per chi apprezza la tenacia e la dedizione!", 'CastoroGiuseppe.png', 'M', 15, 59.99, 600, 'Bosco'),
('Castoro Buster', "Buster è un castoro forte e determinato con il pelo marrone scuro. Sempre impegnato alla costruzione della sua diga, è un vero lavoratore instancabile. Con il suo spirito energico, Buster è il compagno perfetto per chi ama l'avventura e il duro lavoro!", 'CastoroBuster.png', 'S', 6, 19.99, 200, 'Bosco'),
('Riccio Timmy', "Timmy è un riccio piccolo e adorabile, con un musetto simpatico che gli dà un aspetto affettuoso. Sempre curioso, ama nascondersi sotto le foglie e cercare piccole avventure. Con il suo carattere tranquillo e il suo sguardo dolce, Timmy è il compagno perfetto per chi cerca un amico timido e tenero.", 'RiccioTimmy.png', 'S', 20, 19.99, 200, 'Bosco'),
('Pipistrello Midnight', "Midnight è un pipistrello misterioso e affascinante. Sempre in movimento tra le ombre, si sposta agilmente nel cielo notturno. Con il suo carattere tranquillo ma curioso, Midnight è il compagno perfetto per chi apprezza la bellezza e la quiete delle notti più oscure.", 'PipistrelloMidnight.png', 'S', 18, 9.99, 100, 'Bosco'),
('Lupo Hunter', "Hunter è un lupo forte e determinato, con un manto marrone e occhi penetranti. Abile cacciatore, è sempre attento e concentrato. Con il suo carattere fiero e indipendente, Hunter è il compagno perfetto per chi ama l'avventura e la natura incontaminata.", 'LupoHunter.png', 'S', 5, 19.99, 200, 'Bosco'),
('Gufetta Olive', "Olive è una gufetta dolcissima, con piume morbide marrone scuro e occhi grandi e curiosi che brillano nella notte. Sempre silenziosa e attenta, è una grande osservatrice. Con il suo spirito tranquillo e il suo carattere saggio, Olive è la compagna perfetta per chi ama la serenità e la magia della notte.", 'GufettaOlive.png', 'S', 5, 19.99, 200, 'Bosco'),
...
('Uccellino Chip', "Chip è un uccellino vivace e allegro, con piume arancioni brillanti. Con un carattere gioioso e curioso, ama volare di ramo in ramo, cinguettando melodie dolci. Sempre pieno di energia, Chip è il compagno perfetto per chi ama la spensieratezza.", 'UccellinoChip.png', 'S', 5, 12.99, 130, 'Bosco'),
('Leprotto Sky', "Sky è un leprotto agile e curioso, con un manto morbido grigio chiaro. Sempre pronto a saltare e correre, ha uno spirito libero e gioioso. Con occhi grandi e attenti, Sky è sempre alla ricerca di nuove avventure, portando un'aria di leggerezza e freschezza ovunque vada.", 'LeprottoSky.png', 'S', 20, 9.99, 100, 'Bosco'),
...
('Procione Scout', "Scout è un procione vivace e curioso, con il manto grigio e bianco. Sempre in movimento, ama raccogliere piccoli tesori e osservare attentamente il mondo intorno a lui. Con una personalità avventurosa e giocosa, Scout è sempre pronto a scoprire qualcosa di nuovo.", 'ProcioneScout.png', 'S', 5, 9.99, 100, 'Bosco'),
('Procione Dash', "Dash è un procione veloce e scaltro, con il manto color crema. La sua natura avventurosa lo spinge ad essere sempre alla ricerca di piccole sorprese. Dash è un vero esperto nel muoversi furtivo e rapido, con una personalità brillante e piena di energia.", 'ProcioneDash.png', 'S', 7, 19.99, 200, 'Bosco'),
...
('Marmotta Caramel', "Caramel è una marmotta dal carattere dolce e affettuoso. Curiosa e vivace, è sempre pronta a nuove esperienze. Nonostante la sua energia, Caramel è anche molto dolce e un po' timida e ciò rende impossibile per chiunque non amarla.", 'MarmottaCaramel.png', 'S', 4, 17.99, 180, 'Bosco');
